  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center">
        ...
        >
          <div className="absolute translate-y-[0.7rem] w-1.5 h-[1.1rem] rounded-full shadow-md bg-gray-900 dark:bg-gray-50" />
        </div>
        <div
        ...
        >
          <div className="absolute translate-y-[1.05rem] origin-top w-1.5 h-[1.8rem] z-20 rounded-full shadow-md bg-gray-900 dark:bg-gray-50" />
        </div>
        <div
