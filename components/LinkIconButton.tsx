...
export default function LinkIconButton({
  ...
  return (
    <a
      className={cn(
        "size-14 nm-convex-pattens-blue dark:nm-convex-cinder hover:nm-convex-pattens-blue-sm dark:hover:nm-convex-cinder-sm active:nm-concave-pattens-blue-sm dark:active:nm-concave-cinder-sm text-gray-800 hover:text-blue-genie dark:hover:text-blue-genie flex items-center justify-center rounded-full focus-visible:scale-105 focus-visible:text-blue-genie focus dark:focus-visible:text-blue-genie hover:scale-105 active:scale-100 transition cursor-pointer dark:text-white/80",
        className
      )}
      href={link}
      aria-label={
