...
export default function DesktopNavbar() {
  ...
  return (
    <header className="z-[999] hidden sm:block relative">
      <motion.div
        className="top-0 left-1/2 h-16 w-full rounded-none sm:top-5 sm:h-[3.25rem] sm:w-[30rem] sm:rounded-full nav"
        initial={{ y: -100, x: "-50%", opacity: 0 }}
        animate={{ y: 0, x: "-50%", opacity: 1 }}
      ></motion.div>

      <nav className="flex fixed top-[0.15rem] left-1/2 h-12 -translate-x-1/2 py-2 sm:top-[1.45rem] sm:h-[initial] sm:py-0">
